...
public class AES {
	 ...
	 * @throws IOException
	 */
	public void encrypt(int keyLength, String password, InputStream input, OutputStream output)
	 ...
	 * @throws IOException
	 */
	public int decrypt(String password, InputStream input, OutputStream output)
	...
	public class InvalidPasswordException extends Exception {
		private static final long serialVersionUID = 4347338430028220319L; }
	...
	public class InvalidKeyLengthException extends Exception {
		private static final long serialVersionUID = 8567132398252749046L;
	...
	public class StrongEncryptionNotAvailableException extends Exception {
		private static final long serialVersionUID = -6195130527034287493L;
	...
	public class InvalidAESStreamException extends Exception {
		private static final long serialVersionUID = 1982606416918472196L;
